...
!
program rrtmgp_lw_RFMIP_exp01_atmos_quadang
  !
  ...
  do b = 1, nBlocks
    ...
    call compute_lw_fluxes(colS, colE)
  end do
...
contains
  ...
  subroutine compute_lw_fluxes(colS, colE)
  ...
  end subroutine compute_lw_fluxes

end program rrtmgp_lw_RFMIP_exp01_atmos_quadang
